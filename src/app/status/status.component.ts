...
export class StatusComponent {
  // Sample task data
  tasks = [
    { name: 'PSCALE-245688', description: 'Division by Zero and Type Mismatch Errors',  status: ['1', '0', '0', '0', '0', '0','0'] },
    { name: 'PSCALE-226270', description: 'System slow after latest patch is applied',  status: ['2', '2', '2', '1', '0', '0','0'] },
    { name: 'PSCALE-269756', description: 'API not returning expected data in production',  status: ['2', '2', '2', '2', '1', '0','0'] },
